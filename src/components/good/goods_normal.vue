        ...
        <div :class="{'promotion-tips class-a':isshow,'promotion-tips class-b':!isshow}" >
          ...
          <div class="promotion-cont">
            <!-- 促销框内容 -->
              ...
              <!-- <li v-for="(value, index) in item.selpromo" :key="index">
                <label><input @click="getRadioVal(value)" type="radio" :label="value.id" name="radio_31045017189" :value="value.gid === 0 ? value.pid : value.gid">{{value.gname ? value.gname : value.pname}}</label>
              </li> -->
