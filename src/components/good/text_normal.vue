<template>
   <div :class="classTextn">
    ...
    <div  class="s5" v-if="item['operstatus']==0">
      ...
      <!-- 判断iseditqty等于1 有计数器 -->
        <!-- <el-input-number v-if="item['maxqty'] == 0 &&  " v-model="item.updateqty" @change="handleChange" :min="item.minqty" label="描述文字"></el-input-number> -->
        <!-- <el-input-number v-else-if="item['maxqty'] != 0 && item['iseditqty'] == 1" v-model="item.updateqty" @change="handleChange" :min="item.minqty" :max="item.maxqty"></el-input-number> -->
